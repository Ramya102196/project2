...
app.run(function($rootScope, $cookieStore, UserService, $location) {
	...
	$rootScope.logout = function() {
		/*
		 * call middleware logout url -> middleware- remove Httpsession
		 * attribute,update online status to false on success in frontend,remove
		 * cookieStore attribute currentUser , delete $rootscope.
		 */
